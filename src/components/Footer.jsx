...
const Footer = () => {
  return (
    <div className= ' flex gap-5 w-100% h-screen bg-zinc-900 p-20 font-["Founders_Grotesk_X-Condensed"]'>
      <div className='w-1/2 flex h-full flex-col justify-between '>
       <div className='heading'>
       <h1  className='text-[8vw] uppercase leading-none mb-20 '>EYE-</h1>
       <h1  className='text-[8vw] uppercase leading-none mb-20 '>OPENING</h1>
       </div>
       <svg
        width="72" height="30" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
         ...
         <div className='w-1/2'>
         <h1  className='text-[6vw] uppercase  leading-none mb-20 '>
            Presentations
           
         </h1>
         <div className='dets font-["Neue_Montreal] mt-10'>
                <a className='block text-xl font-light' href="https://www.facebook.com/people/OCHI-presentation-design/100067218942460/">Facebook</a>
                <a className='block text-xl font-light' href="https://www.instagram.com/ochi_design/">Instagram</a>
                <a className='block text-xl font-light' href="https://www.linkedin.com/uas/login?session_redirect=%2Fcompany%2F56403597">Linkedin</a>
                <a className='block text-xl font-light' href="https://www.behance.net/ochi_design">Behance</a>
            </div>
         </div>
